...
tkadd(main$env$menu, "cascade", label="Plot",menu=main$env$menuFile)
tkadd(main$env$menuFile, "command", label = "Load 4C dataset(s)", command=load.4c)
...
ok=tkbutton(main,text="Generate/update plot",command=refresh.gui)
